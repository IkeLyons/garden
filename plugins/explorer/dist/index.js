    ...
    return /* @__PURE__ */ u2(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ u2("div", { id, class: "explorer-content", "aria-expanded": false, role: "group", children: [
            /* @__PURE__ */ u2("button", { type: "button", class: "mobile-search-trigger", "aria-label": "Search", children: [
              /* @__PURE__ */ u2(
                "svg",
                {
                  xmlns: "http://www.w3.org/2000/svg",
                  ...
                  width: "18",
                  height: "18",
                  children: /* @__PURE__ */ u2("g", { fill: "none", stroke: "currentColor", "stroke-width": "1.5", children: [
                    /* @__PURE__ */ u2("path", { "stroke-linecap": "square", d: "M18.5 18.3l-5.4-5.4" }),
                    /* @__PURE__ */ u2("circle", { cx: "8", cy: "8", r: "7" })
                  ] })
                }
              ),
              /* @__PURE__ */ u2("span", { children: "Search..." })
            ] }),
...
document.addEventListener("nav", setupMobileSearchTrigger);
document.addEventListener("render", setupMobileSearchTrigger);
`;
  ExplorerComponent.css = explorer_default;
  ExplorerComponent.afterDOMLoaded = concatenateResources(explorer_inline_default, overflowListAfterDOMLoaded, mobileSearchScript);
