    ...
    return (
      ...
      >
        ...
        <div id={id} class="explorer-content" aria-expanded={false} role="group">
          <button type="button" class="mobile-search-trigger" aria-label="Search">
            <svg
              xmlns="http://www.w3.org/2000/svg"
...
`;
  ...
  ExplorerComponent.afterDOMLoaded = concatenateResources(script, overflowListAfterDOMLoaded, mobileSearchScript);
