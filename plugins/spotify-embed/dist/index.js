...
// src/styles/spotify-embed.scss
var spotify_embed_default = ".spotify-embed {\n  margin: 1.5rem 0;\n  border-radius: 12px;\n  overflow: hidden;\n}\n.spotify-embed iframe {\n  display: block;\n  border: none;\n  width: 100%;\n}";

// src/transformer.ts
var SPOTIFY_URL_RE = /^https?:\/\/open\.spotify\.com\/(track|album|playlist|episode|show|artist)\/([A-Za-z0-9]+)/;
var TALL_TYPES = /* @__PURE__ */ new Set(["album", "playlist", "artist", "show"]);
var defaultOptions = {
  theme: "dark",
  trackHeight: 152,
  albumHeight: 352
};
var SpotifyEmbed = (userOpts) => {
  const opts = { ...defaultOptions, ...userOpts };
  return {
    name: "SpotifyEmbed",
    externalResources() {
      return { css: [{ content: spotify_embed_default, inline: true }] };
    },
    htmlPlugins() {
      return [
        () => (tree) => {
